...
Counted with contractions and hyphenated terms as one word. Every landing sentence is 22 words or fewer and contains no banned plain-words term.

| Sentence | Words | Result |
| --- | ---: | --- |
| Turn scanned barcodes into item cards | 6 | pass |
...
| Camera scanning fills the barcode field. You can also type English letters, numbers, spaces, and punctuation. | 16 | pass |
